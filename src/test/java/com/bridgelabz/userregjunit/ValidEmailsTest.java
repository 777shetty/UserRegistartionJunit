...
public class ValidEmailsTest 
{
	private String emailTotest;
	private boolean expectedResult;

	public ValidEmailsTest(String emailToTest,boolean expectedResult) 
	...
	public void givenEmailAsVariable_ShouldReturnAsPerTheParameteriszedResult() 
	{
		...
		boolean result=userValidator.validateName(this.emailTotest);
